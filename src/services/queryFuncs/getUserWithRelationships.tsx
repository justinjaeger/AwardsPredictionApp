...
// TODO: didn't actually do this yet
// idk how to do this without overfetching for popular users TBD
const getUserWithRelationships = async (
  id: string | undefined,
): Promise<iUser | undefined> => {
  return undefined;
  //   if (id === undefined) return undefined;
  //   const { data } = await ApiServices.getUserWithRelationships(id);
...
export default getUserWithRelationships;
